...
pub const Match:  u32 = 256;
pub const Split:  u32 = 257;
...
unsafe fn main_0(argc: libc::c_int, argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    l1.s = malloc( (nstate as libc::c_ulong).wrapping_mul(core::mem::size_of:: <*mut State> () as libc::c_ulong) ) as *mut *mut State;
