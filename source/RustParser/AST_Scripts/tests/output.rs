...
//     l1
//         .s = malloc(
//         (nstate as libc::c_ulong)
//             .wrapping_mul(::core::mem::size_of::<*mut State>() as libc::c_ulong),
//     ) as *mut *mut State;
//     l2
//         .s = malloc(
//         (nstate as libc::c_ulong)
...
//     unsafe {
//         ::std::process::exit(main_0((args.len() - 1) as libc::c_int, args.as_mut_ptr() as *mut *mut libc::c_char,) as i32,);
//     }
// }
