# Generated from /Users/chandeepadissanayake/Desktop/Dev/LiGroup/c2rust/rust/parser/Rust.g4 by ANTLR 4.13.1
from antlr4 import *
if "." in __name__:
...
class RustVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by RustParser#arrayAccess.
    def visitArrayAccess(self, ctx:RustParser.ArrayAccessContext):
        return self.visitChildren(ctx)
